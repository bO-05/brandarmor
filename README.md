...
- App version: `0.5.0`.
- Automated tests: `200/200` passing with `BPOM_DISABLE_API=1`.
...
- Last local verification: `npm run typecheck`, `BPOM_DISABLE_API=1 npm test` (`200/200`), `npm run build`, React Doctor `100/100`, five consecutive staged-demo/report runs, and HTTP smoke checks for `/`, `/demo`, `/listings/new`, `/listings/import`, `/review`, `/evaluation`, a linked listing detail page, and both report formats.
